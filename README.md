...
- Create `02a_navigation_map.md` (screen flow, relationships, and Mermaid diagram with WCAG-compliant colors)
...
```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/refs/heads/main/install.sh | sh -s -- --version v0.1.0
```
...
```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/refs/heads/main/install.sh | sh -s -- --update
```

### Uninstall

```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/refs/heads/main/install.sh | sh -s -- --uninstall
```
