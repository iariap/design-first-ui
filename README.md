...
```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/main/install.sh | sh
```

### Pin a version

```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/main/install.sh | sh -s -- --version v0.1.0
```

### Custom install directory

```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/main/install.sh | sh -s -- --dir .design-first-ui
```

### Update

```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/main/install.sh | sh -s -- --update
```

### Uninstall

```sh
curl -fsSL https://github.com/iariap/design-first-ui/raw/main/install.sh | sh -s -- --uninstall
```
